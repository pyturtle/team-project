...
public class CalendarState {
    ...
    // Store filter criteria for re-applying filters
    private String filterPlanId = null;
    private String filterSubgoalName = null;
    private Boolean filterPriorityOnly = null;
    ...
    public void clearFilter() {
        ...
        this.filterSubgoalName = null;
        this.filterPriorityOnly = null;
    }

    public void setFilterCriteria(String planId, String subgoalName, Boolean priorityOnly) {
        this.filterPlanId = planId;
        this.filterSubgoalName = subgoalName;
        this.filterPriorityOnly = priorityOnly;
    }

    public String getFilterPlanId() {
        return filterPlanId;
    }

    public String getFilterSubgoalName() {
        return filterSubgoalName;
    }

    public Boolean getFilterPriorityOnly() {
        return filterPriorityOnly;
    }
